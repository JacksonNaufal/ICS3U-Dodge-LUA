function love.load()
    ...
    myFont = love.graphics.newFont('font.TTF',30)
    smallerFont = love.graphics.newFont('font.TTF',15)
...
function love.draw()
    ...
    if gameState == 1 then
        ...
        love.graphics.printf("AVOID THE BOMBS", 250, 150, love.graphics.getWidth(), "center")
        love.graphics.printf("(-50 Player Speed)", 250, 175, love.graphics.getWidth(), "center")
        love.graphics.printf("GATHER THE LIGHTING BOLTS", -250, 150, love.graphics.getWidth(), "center")
        love.graphics.printf("(+25 Player Speed)", -250, 175, love.graphics.getWidth(), "center")
    end
